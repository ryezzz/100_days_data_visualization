    ...
    vegTextLink.on('click',function(){
           var active  = gdp.active ? false : true,
               ...
               newOpacityReverse = active ? 1 : 0;
                 ...
                 .style("grid-template-rows", "5% 5% 8% 25%")
...
// var minResponsive = 795
// var baseHeight = window.innerHeight/3.8;
// var chartDiv = d3.selectAll('.chartsContainer')





// var width = parseInt(chartDiv.style('width'))*.90
// var height =  parseInt(chartDiv.style('height'))*.3;
// var margin = { top: 100, right: 0, bottom: 0, left: width*.079, }
